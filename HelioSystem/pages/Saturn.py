...
planetModel.translate((0, 0.0, 0.0), inplace=True)
...
plotter.add_mesh(examples.planets.load_saturn_rings(inner=4500, outer=8000, c_res=50), texture=examples.planets.download_saturn_rings(texture=True), smooth_shading=True)
