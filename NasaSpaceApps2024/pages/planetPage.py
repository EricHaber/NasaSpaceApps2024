...
if not "AllMessages" in st.session_state:
    st.session_state.AllMessages=[{"role": "system", "content": "You are a knowledgeable astronomer and should briefly answer any of the users questions about Mars."}]
...
with st.chat_message("assistant"):
    st.markdown("Space Bot: Hello 👋 do you have any questions about Mars?")
