...
with col1:
    st.image("d:/Documents/Coding/NasaSpaceApps2024/images/heliosystem.png") #, width=1250
with col2:
...
st.header("The Team")
st.image("d:/Documents/Coding/NasaSpaceApps2024/images/Noel.jpeg", width=200, caption="Noël Santiago Briand: French, born 5th May 2011. Coder, Designer")
st.image("d:/Documents/Coding/NasaSpaceApps2024/images/Eric.jpeg", width=200, caption="Eric Haber Florencio: Brazilian, born in the U.S.A. 18th October 2010. Coder, Designer")
st.image("d:/Documents/Coding/NasaSpaceApps2024/images/Lilian.jpeg", width=200, caption="Lilian Tillie Ronzon: French, born 8th November 2011. Coder, Presenter")
st.image("d:/Documents/Coding/NasaSpaceApps2024/images/Pablo.jpeg", width=200, caption="Pablo Almagro González: Spanish, born in China 11th July 2010. Designer, Coder and Organizer")
st.image("d:/Documents/Coding/NasaSpaceApps2024/images/Andrew.jpeg", width=200, caption="Andrés Almagro González: Spanish, born in China 12th December 2011. Designer, Presenter")
